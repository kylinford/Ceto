...
namespace Ceto
{
	...
	public class WaveSpectrum : OceanComponent
	{
		...
		public Material M_SlopeCopyMat => m_slopeCopyMat;
		public Material M_DisplacementCopyMat => m_displacementCopyMat;
		public Material M_FoamCopyMat => m_foamCopyMat;

		/// <summary>
		/// Materials used to init the fourier data for the GPU buffers.
		/// </summary>
		Material m_slopeInitMat, m_displacementInitMat, m_foamInitMat;
		public Material M_SlopeInitMat => m_slopeInitMat;
		public Material M_DisplacementInitMat => m_displacementInitMat;
		public Material M_FoamInitMat => m_foamInitMat;
		...
		public WaveSpectrumCondition[] M_Conditions => m_conditions;
		...
		public WaveSpectrumBuffer M_DisplacementBuffer => m_displacementBuffer;
		public WaveSpectrumBuffer M_SlopeBuffer => m_slopeBuffer;
		public WaveSpectrumBuffer M_JacobianBuffer => m_jacobianBuffer;
